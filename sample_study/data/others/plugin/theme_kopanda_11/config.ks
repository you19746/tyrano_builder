...
;===========================================================================================================================
	...
	// 画像類のファイル名とパス
	tf.img_path       = '../others/plugin/theme_kopanda_11/image/config/';
	tf.btn_path_off   = tf.img_path + 'config_check_off.png';
	tf.btn_path_on    = tf.img_path + 'config_check_on.png';
	tf.img_bgmmute    = tf.img_path + 'config_bgmmute_on.png';
	tf.img_semute     = tf.img_path + 'config_semute_on.png';
	tf.img_unreadskip = tf.img_path + 'config_unreadskip_on.png';

	// 配置座標
	tf.config_x = [1085, 478, 532, 586, 640, 694, 748, 802, 856, 910, 964];
	tf.config_y = [185, 255, 325, 395];

	// チェック画像の幅と高さ
	tf.img_check_width  = 45;
	tf.img_check_height = 39;
...
[cm]
	...
	[button fix="true" graphic="&tf.img_path + 'back.png'" enterimg="&tf.img_path + 'back2.png'" target="*backtitle" x="10" y="583"]
...
; BGM音量
;------------------------------------------------------------------------------------------------------
	[button name="bgmvol,bgmvol_10"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[1]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  10; tf.config_num_bgm =  1"]
	[button name="bgmvol,bgmvol_20"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[2]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  20; tf.config_num_bgm =  2"]
	[button name="bgmvol,bgmvol_30"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[3]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  30; tf.config_num_bgm =  3"]
	[button name="bgmvol,bgmvol_40"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[4]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  40; tf.config_num_bgm =  4"]
	[button name="bgmvol,bgmvol_50"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[5]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  50; tf.config_num_bgm =  5"]
	[button name="bgmvol,bgmvol_60"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[6]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  60; tf.config_num_bgm =  6"]
	[button name="bgmvol,bgmvol_70"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[7]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  70; tf.config_num_bgm =  7"]
	[button name="bgmvol,bgmvol_80"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[8]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  80; tf.config_num_bgm =  8"]
	[button name="bgmvol,bgmvol_90"  fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[9]"  y="&tf.config_y[0]" exp="tf.current_bgm_vol =  90; tf.config_num_bgm =  9"]
	[button name="bgmvol,bgmvol_100" fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[10]" y="&tf.config_y[0]" exp="tf.current_bgm_vol = 100; tf.config_num_bgm = 10"]

;	BGMミュート
;	[button name="bgmvol,bgmvol_0"   fix="true" target="*vol_bgm_change" graphic="&tf.btn_path_off" width="134" height="39" x="&tf.config_x[0]" y="&tf.config_y[0]" exp="tf.current_bgm_vol = 0; tf.config_num_bgm = 0"]
	[button name="bgmvol,bgmvol_0"   fix="true" target="*vol_bgm_mute" graphic="&tf.btn_path_off" width="134" height="39" x="&tf.config_x[0]" y="&tf.config_y[0]"]

;------------------------------------------------------------------------------------------------------
; SE音量
;------------------------------------------------------------------------------------------------------
	[button name="sevol,sevol_10"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[1]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  10; tf.config_num_se =  1"]
	[button name="sevol,sevol_20"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[2]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  20; tf.config_num_se =  2"]
	[button name="sevol,sevol_30"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[3]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  30; tf.config_num_se =  3"]
	[button name="sevol,sevol_40"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[4]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  40; tf.config_num_se =  4"]
	[button name="sevol,sevol_50"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[5]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  50; tf.config_num_se =  5"]
	[button name="sevol,sevol_60"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[6]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  60; tf.config_num_se =  6"]
	[button name="sevol,sevol_70"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[7]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  70; tf.config_num_se =  7"]
	[button name="sevol,sevol_80"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[8]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  80; tf.config_num_se =  8"]
	[button name="sevol,sevol_90"  fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[9]"  y="&tf.config_y[1]" exp="tf.current_se_vol =  90; tf.config_num_se =  9"]
	[button name="sevol,sevol_100" fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="&tf.img_check_width" height="&tf.img_check_height" x="&tf.config_x[10]" y="&tf.config_y[1]" exp="tf.current_se_vol = 100; tf.config_num_se = 10"]

;	SEミュート
;	[button name="sevol,sevol_0"   fix="true" target="*vol_se_change" graphic="&tf.btn_path_off" width="134" height="39" x="&tf.config_x[0]" y="&tf.config_y[1]" exp="tf.current_se_vol = 0; tf.config_num_se = 0"]
	[button name="sevol,sevol_0"   fix="true" target="*vol_se_mute" graphic="&tf.btn_path_off" width="134" height="39" x="&tf.config_x[0]" y="&tf.config_y[1]"]
...
;------------------------------------------------------------------------------------------------------
;	未読スキップオン
	[button name="unread_on" fix="true" target="*skip_on" graphic="&tf.btn_path_off" width="134" height="39" x="&tf.config_x[0]" y="&tf.config_y[3]"]
...
*skip_on
	...
	[else]
	[image name="skip" layer="0" storage="&tf.img_unreadskip" x="&tf.config_x[0]" y="&tf.config_y[3]" width="134" height="39"]
...
*load_bgm_img
	...
	[image layer="0" name="bgmvol" storage="&tf.img_bgmmute" x="&tf.config_x[0]" y="&tf.config_y[0]"]
	[else]
...
*load_se_img
	...
	[image layer="0" name="sevol" storage="&tf.img_semute" x="&tf.config_x[0]" y="&tf.config_y[1]"]
	[else]
...
*load_skip_img
	[if exp="tf.text_skip == 'ON'"]
	[image layer="0" name="skip" storage="&tf.img_unreadskip" x="&tf.config_x[0]" y="&tf.config_y[3]"]
	[endif]
[return]
