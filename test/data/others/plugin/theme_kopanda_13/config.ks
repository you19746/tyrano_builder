...
;===========================================================================================================================
	...
	tf.img_path = '../others/plugin/theme_kopanda_13/image/config/';
	tf.btn_path_off = tf.img_path + 'c_btn.gif';
	tf.btn_path_on  = tf.img_path + 'set.png';
	tf.img_check    = tf.img_path + 'check.png';
	tf.config_x = [1088, 434,　494, 554, 614, 674, 734, 794, 854, 914, 974];
	tf.config_y = [175, 253, 331, 409];
...
[cm]
	...
	[button fix="true" graphic="&tf.img_path + 'back.png'" enterimg="&tf.img_path + 'back2.png'" target="*backtitle" x="1140" y="40"]
...
;	BGMミュート
	[button name="bgmvol,bgmvol_0"   fix="true" target="*vol_bgm_mute" graphic="&tf.btn_path_off" width="24" height="24" x="1088" y="188"]
...
;	SEミュート
	[button name="sevol,sevol_0"   fix="true" target="*vol_se_mute" graphic="&tf.btn_path_off" width="24" height="24" x="1088" y="265"]
...
;------------------------------------------------------------------------------------------------------
;	未読スキップ-ON
	[button name="unread_on"  fix="true" target="*skip_on"  graphic="&tf.btn_path_off" width="164" height="44" x="614" y="494"]

;	未読スキップ-OFF
	[button name="unread_off" fix="true" target="*skip_off" graphic="&tf.btn_path_off" width="164" height="44" x="434" y="494"]
...
*skip_off
	...
	[image layer="0" name="unread_off" storage="../others/plugin/theme_kopanda_13/image/config/skip_off.png" x="434" y="494"]
...
*skip_on
	...
	[image layer="0" name="unread_on" storage="../others/plugin/theme_kopanda_13/image/config/skip_on.png" x="614" y="494"]
...
*load_bgm_img
	...
	[image layer="0" name="bgmvol" storage="&tf.img_check" x="1085" y="177"]
	[else]
...
*load_se_img
	...
	[image layer="0" name="sevol" storage="&tf.img_check" x="1085" y="254"]
	[else]
