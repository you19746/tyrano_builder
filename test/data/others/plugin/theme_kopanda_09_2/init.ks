...
[position layer="message0" frame="../others/plugin/theme_kopanda_09_2/image/frame_message.png" margint="110" marginl="140" marginr="150" opacity="&mp.frame_opacity" page="fore"]
...
;クイックセーブボタン
[button name="role_button" role="quicksave" graphic="../others/plugin/theme_kopanda_09_2/image/button/qsave.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/qsave2.png" x="152" y="693"]

;クイックロードボタン
[button name="role_button" role="quickload" graphic="../others/plugin/theme_kopanda_09_2/image/button/qload.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/qload2.png" x="234" y="693"]

;セーブボタン
[button name="role_button" role="save" graphic="../others/plugin/theme_kopanda_09_2/image/button/save.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/save2.png" x="316" y="693"]

;ロードボタン
[button name="role_button" role="load" graphic="../others/plugin/theme_kopanda_09_2/image/button/load.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/load2.png" x="398" y="693"]

;オートボタン
[button name="role_button" role="auto" graphic="../others/plugin/theme_kopanda_09_2/image/button/auto.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/auto2.png" x="480" y="693"]

;スキップボタン
[button name="role_button" role="skip" graphic="../others/plugin/theme_kopanda_09_2/image/button/skip.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/skip2.png" x="562" y="693"]

;バックログボタン
[button name="role_button" role="backlog" graphic="../others/plugin/theme_kopanda_09_2/image/button/log.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/log2.png" x="644" y="693"]

;フルスクリーン切替ボタン
[button name="role_button" role="fullscreen" graphic="../others/plugin/theme_kopanda_09_2/image/button/screen.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/screen2.png" x="726" y="693"]

;コンフィグボタン（※sleepgame を使用して config.ks を呼び出しています）
[button name="role_button" role="sleepgame" graphic="../others/plugin/theme_kopanda_09_2/image/button/sleep.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/sleep2.png" storage="../others/plugin/theme_kopanda_09_2/config.ks" x="808" y="693"]

;メニュー呼び出しボタン（※ロールボタンを使うなら不要）
[button name="role_button" role="menu" graphic="../others/plugin/theme_kopanda_09_2/image/button/menu.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/menu2.png" x="890" y="693"]

;メッセージウィンドウ非表示ボタン
[button name="role_button" role="window" graphic="../others/plugin/theme_kopanda_09_2/image/button/close.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/close2.png" x="972" y="693"]

;タイトルに戻るボタン
[button name="role_button" role="title" graphic="../others/plugin/theme_kopanda_09_2/image/button/title.png" enterimg="../others/plugin/theme_kopanda_09_2/image/button/title2.png" x="1054" y="693"]
...
f.theme_img_list = [
'./data/others/plugin/theme_kopanda_09_2/image/config/off.gif',
'./data/others/plugin/theme_kopanda_09_2/image/config/on.png',
'./data/others/plugin/theme_kopanda_09_2/image/config/check.png',
'./data/others/plugin/theme_kopanda_09_2/image/config/c_btn_back.png',
'./data/others/plugin/theme_kopanda_09_2/image/config/c_btn_back2.png',
'./data/others/plugin/theme_kopanda_09_2/image/config/bg_config.jpg',
